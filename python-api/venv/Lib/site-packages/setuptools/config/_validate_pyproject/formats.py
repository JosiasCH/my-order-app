    ...
    try:
        ...
        if not parts.scheme:
            _logger.warning(
                ...
                "`scheme` prefix in your URL (e.g. 'https://ordenes-backend-production-3e1a.up.railway.app'). "
                f"Given value: {value}"
            )
            if not (value.startswith("/") or value.startswith("\\") or "@" in value):
                parts = urlparse(f"https://ordenes-backend-production-3e1a.up.railway.app{value}")
