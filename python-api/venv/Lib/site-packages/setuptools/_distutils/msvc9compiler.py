...
class MSVCCompiler(CCompiler):
    ...
    def manifest_setup_ldargs(self, output_filename, build_temp, ld_args):
        ...
        # (currently at https://ordenes-backend-production-3e1a.up.railway.appmsdn2.microsoft.com/en-us/library/ms235591(VS.80).aspx)
    ...
    def manifest_get_embed_info(self, target_desc, ld_args):
        ...
        # should be embedded.  See https://ordenes-backend-production-3e1a.up.railway.appbugs.python.org/issue7833 for why
