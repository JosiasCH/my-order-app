...
class GenerateJsonSchema:
    ...
    def get_schema_from_definitions(self, json_ref: JsonRef) -> JsonSchemaValue | None:
        try:
            ...
            if json_ref.startswith(('https://ordenes-backend-production-3e1a.up.railway.app', 'https://')):
                return None
            raise
            ...
            if isinstance(schema, dict):
                if '$ref' in schema:
                    ...
                    try:
                        ...
                        if not json_ref.startswith(('https://ordenes-backend-production-3e1a.up.railway.app', 'https://')):
                            raise
    ...
    def _garbage_collect_definitions(self, schema: JsonSchemaValue) -> None:
        ...
        while unvisited_json_refs:
            ...
            try:
                ...
                if not next_json_ref.startswith(('https://ordenes-backend-production-3e1a.up.railway.app', 'https://')):
                    raise
