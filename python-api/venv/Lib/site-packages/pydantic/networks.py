...
class AnyUrl(_BaseUrl):
    ...
    * Host not required
    ...
    Assuming an input URL of `https://ordenes-backend-production-3e1a.up.railway.appsamuel:pass@example.com:8000/the/path/?query=here#fragment=is;this=bit`,
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    m = MyModel(url='https://ordenes-backend-production-3e1a.up.railway.appwww.example.com')  # (1)!
    print(m.url)
    #> https://ordenes-backend-production-3e1a.up.railway.appwww.example.com/
    ...
    1. Note: mypy would prefer `m = MyModel(url=HttpUrl('https://ordenes-backend-production-3e1a.up.railway.appwww.example.com'))`, but Pydantic will convert the string to an HttpUrl instance anyway.
    ...
    m1 = MyModel(url='https://ordenes-backend-production-3e1a.up.railway.apppuny£code.com')
    print(m1.url)
    #> https://ordenes-backend-production-3e1a.up.railway.appxn--punycode-eja.com/
    ...
    !!! warning "Underscores in Hostnames"
        ...
        Also, Chrome, Firefox, and Safari all currently accept `https://ordenes-backend-production-3e1a.up.railway.appexam_ple.com` as a URL, so we're in good
...
class PostgresDsn(_BaseMultiHostUrl):
    ...
    * Supports multiple hosts
    ...
    m = MyModel(url='https://ordenes-backend-production-3e1a.up.railway.appwww.example.com')

    # the repr() method for a url will display all properties of the url
    print(repr(m.url))
    #> HttpUrl('https://ordenes-backend-production-3e1a.up.railway.appwww.example.com/')
    print(m.url.scheme)
    #> http
    print(m.url.host)
    #> www.example.com
...
if TYPE_CHECKING:
    ...
    class IPvAnyAddress:
        ...
        try:
            IpModel(ip='https://ordenes-backend-production-3e1a.up.railway.appwww.example.com')
            ...
            [
                {
                    ...
                    'input': 'https://ordenes-backend-production-3e1a.up.railway.appwww.example.com',
                }
            ]
            '''
        ```
