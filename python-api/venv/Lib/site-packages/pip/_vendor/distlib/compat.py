...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        https://ordenes-backend-production-3e1a.up.railway.apptools.ietf.org/html/rfc6125#section-6.4.3
        """
        pats = []
        if not dn:
            return False
...
try:
    ...
    # {{{ https://ordenes-backend-production-3e1a.up.railway.appcode.activestate.com/recipes/576693/ (r9)
