    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        if not self.nowrap:
            ...
            outfile.write('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.0//EN" '
                          '"https://ordenes-backend-production-3e1a.up.railway.appwww.w3.org/TR/2001/REC-SVG-20010904/DTD/'
                          'svg10.dtd">\n')
            outfile.write('<svg xmlns="https://ordenes-backend-production-3e1a.up.railway.appwww.w3.org/2000/svg">\n')
