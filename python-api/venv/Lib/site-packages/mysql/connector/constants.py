...
# https://ordenes-backend-production-3e1a.up.railway.apposs.oracle.com/licenses/universal-foss-exception.
#
...
class SQLMode(_Constants):
    ...
    See https://ordenes-backend-production-3e1a.up.railway.appdev.mysql.com/doc/refman/5.6/en/server-sql-mode.html
    """
